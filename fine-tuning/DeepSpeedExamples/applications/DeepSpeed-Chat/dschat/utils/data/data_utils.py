...
def get_raw_dataset(dataset_name, output_path, seed, local_rank, tokenizer):
    ...
    if "Dahoas/rm-static" in dataset_name:
        ...
        return raw_datasets.DahoasFullhhrlhfDataset(output_path, seed,
                                                    local_rank, dataset_name, tokenizer)
        ...
        return raw_datasets.YitingxieRlhfrewarddatasetsDataset(
            output_path, seed, local_rank, dataset_name, tokenizer)
        ...
        return raw_datasets.LocalJsonFileDataset(output_path, seed, local_rank,
                                                 dataset_name, chat_path, tokenizer)
    else:
        raise RuntimeError(
